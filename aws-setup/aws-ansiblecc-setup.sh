...
sudo apt-get update
sudo apt-get install git git-extras software-properties-common python-pip python-dev -y
sudo pip install boto
sudo pip install markupsafe         # markupsafe is a dependency of ansible, required!
